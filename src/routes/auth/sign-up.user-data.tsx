...
import { createUser, getJwt, getSessionData } from '@/lib/auth-session'
...
const fieldConfigsFn = (
  specialists: Array<SpecialistResponse>,
): FieldConfigs<UserDataSchema> => {
    ...
    <div className="flex flex-col gap-6">
      <Card className="[view-transition-name:auth-card]">
        <CardHeader>
          ...
          <CardDescription>
            Fill up the form with your contact and address information, as well
            as your primary care specialist.
          </CardDescription>
        </CardHeader>
...
function UserDataForm() {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value: data }) => {
      ...
      const nextState =
        sessionData.state === 'profile-update' ? 'profile-update' : 'user-data'
