    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent className="min-w-fit p-6">
        <DialogHeader className="px-6 pt-6">
          ...
          <DialogDescription>
            Book an appointment with a General Practice specialist to renew your
            prescription or discuss your current medications.
          </DialogDescription>
        </DialogHeader>
        ...
        {isLoadingSpecialists ? (
          ...
          <>
            <Field>
              ...
              <FieldDescription>
                Your appointment will be scheduled with an available GP
                specialist
              </FieldDescription>
            </Field>
